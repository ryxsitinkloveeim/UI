if (game:GetService("CoreGui")):FindFirstChild("Xeron Hub") and (game:GetService("CoreGui")):FindFirstChild("ScreenGui") then
	(game:GetService("CoreGui")).Xeron Hub:Destroy();
	(game:GetService("CoreGui")).ScreenGui:Destroy();
end;
_G.Primary = Color3.fromRGB(255, 255, 255)
_G.Dark = Color3.fromRGB(20, 20, 20)
...
ImageButton.Image = "rbxassetid://115563307048730";
ImageButton.AutoButtonColor = false;
MakeDraggable(ImageButton, OutlineButton);
CreateRounded(ImageButton, 10);
ImageButton.MouseButton1Click:connect(function()
	(game.CoreGui:FindFirstChild("Xeron Hub")).Enabled = not (game.CoreGui:FindFirstChild("Xeron Hub")).Enabled;
end);
...
function Update:Notify(desc)
	...
	Image.Image = "rbxassetid://115563307048730";
	Title.Parent = Frame;
...
(getgenv()).LoadConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfolder("Xeron Hub") then
			makefolder("Xeron Hub");
		end;
		if not isfolder("Xeron Hub/Library/") then
			makefolder("Xeron Hub/Library/");
		end;
		if not isfile(("Xeron Hub/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			writefile("Xeron Hub/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(SettingsLib));
		else
			local Decode = (game:GetService("HttpService")):JSONDecode(readfile("Xeron Hub/Library/" .. game.Players.LocalPlayer.Name .. ".json"));
...
(getgenv()).SaveConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfile(("Xeron Hub/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			...
			writefile("Xeron Hub/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(Array));
		end;
	else
		return warn("Status : Undetected Executor");
	end;
...
function Update:Window(Config)
	...
	local Xeron Hub = Instance.new("ScreenGui");
	Xeron Hub.Name = "Xeron Hub";
	Xeron Hub.Parent = game.CoreGui;
	Xeron Hub.DisplayOrder = 999;
	local OutlineMain = Instance.new("Frame");
	OutlineMain.Name = "OutlineMain";
	OutlineMain.Parent = Xeron Hub;
	...
	function uitab:Tab(text, img)
		...
		function main:Seperator(text)
			...
			Sep1.RichText = true;
			Sep1.Text = "Xeron Hub<font color=\"rgb(255, 255, 255)\">Xeron Hub</font>";
			...
			Sep3.RichText = true;
			Sep3.Text = "<font color=\"rgb(255, 255, 255)\">Xeron Hub</font>Xeron Hub";
